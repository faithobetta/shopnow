...
const Cart = () => {
    ...
    const [address, setAddress] = useState("ludo vick")
  ...
  return (
    <div className='container mt-32 mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24'>
      {cart.products.length > 0 ? (
        <div>
            <h3 className='text-2xl font-semibold mb-4 flex justify-center'>Shopping Cart</h3>
                ...
                <div className='md:w-2/3'>
                        ...
                        {cart.products.map((product) =>(
                            <div key={product.id} className='flex items-center justify-between p-3 border-b'>
                                <div className='md:flex items-center space-x-4'>
                                    <img src={product.imagedata} alt={product.imagedata} className='w-16 h-16 object-contain rounded'/>
                    ...
                    <div className=' bg-white p-6 rounded-lg shadow-md border'>
                        ...
                        <div className='mb-4 border-b pb-2'>
                            ...
                            <button className='text-blue-500 hover:underline mt-1 ml-2' onClick={() => setIsModelOpen(true)}>Change Shipping Address</button>
                        </div>
                        ...
                        <div className='flex justify-center'>
                            <button className='w-1/3 bg-black text-white py-2 hover:bg-gray-800' onClick={() => navigate("/checkout")}>Checkout</button>
                        </div>
            ...
            <Modal isModelOpen={isModelOpen}
                setIsModelOpen = {setIsModelOpen}> <ChangeAddress setAddress={setAddress} setIsModelOpen={setIsModelOpen} /> </Modal>
        </div>
       ) : (
        <div className='flex justify-center'>
